export default {
	...
	settings: {
		...
		serverUrl: {
			...
			desc: 'Enter your WebDAV server URL',
			placeholder: 'https://pan.ustc.edu.cn/seafdav/',
		},
		account: {
			name: 'Account',
		...
		help: {
			name: 'How to get WebDAV account and password?',
			desc: 'Check your WebDAV provider documentation',
		},
		filters: {
			name: 'Sync filters',
		...
		cache: {
			...
			dumpDesc:
				'The plugin stores remote folder information locally. When switching devices, this data is lost and must be rebuilt before syncing. With many files, rebuilding can be slow. Export saves this data to your WebDAV server; Import retrieves it, allowing immediate syncing on new devices.',
	...
	sync: {
		...
		suggestUseClientForManyTasks:
			'Tip: When there are many sync tasks, sync may take longer. Please be patient!',
		modalTitle: 'Syncing',
